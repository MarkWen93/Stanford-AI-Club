...
<section id="newsletter" className="bg-white text-center py-24 px-4 sm:px-6 fade-in-section">
  <h2 className="text-2xl sm:text-4xl font-extrabold text-[#8C1515] mb-4">Stay in the Loop</h2>
  <div className="w-12 h-1 bg-[#8C1515] mx-auto mb-8" />
  <p className="text-base sm:text-lg text-[#2C1E3D] max-w-2xl mx-auto mb-8">
    Be the first to know about new events, featured projects, and exclusive insights from our AI Builder community.
  </p>
  <form className="max-w-xl mx-auto flex flex-col sm:flex-row items-center gap-4">
    <input
      type="email"
      placeholder="Enter your email"
      className="flex-grow w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8C1515] text-sm"
    />
    <button
      type="submit"
      className="bg-[#8C1515] text-white px-6 py-3 rounded-md font-bold hover:bg-[#A33333] transition w-full sm:w-auto"
    >
      Subscribe
    </button>
  </form>
